    ...
    <>
      ...
      >
        ...
        <p className="text-gray-200 text-[18px] max-w-[500px]">
         My name is Zafran Khan Khattak (ZKK). I am a student of PIAIC of batch-52 of Lahore. Besically, i did my intermediate from my home town Karak (KPK) and now i am doing Generative AI course from PIAIC.Currently I am studying in second semester.
        </p>
        <button
